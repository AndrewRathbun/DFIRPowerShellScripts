...
try
{
	...
	{
		[void] (New-Item -ItemType Directory $Destination -Confirm:$false)
	}
	# Read in the $Inputdir and look for ConsoleHost_history.txt
	$files = Get-ChildItem -Path $InputDir -Filter "ConsoleHost_history.txt" -Recurse -ErrorAction Stop | ForEach-Object{ $_.FullName }
	...
	foreach ($file in $files)
	{
		...
		$FullDest = Join-Path $Destination $username
		$FullDest = Join-Path $FullDest $filename
		# Copy-Item won't create the folder structure so we have to
		# Create a blank file and then overwrite it
		$null = New-Item -Path $FullDest -Type File -Confirm:$false
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAzkCDkeYJzlkFK
# ejrskIgpRWvsc1djl5n3PTmbu9ORBKCCEgowggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# gjcCARUwLwYJKoZIhvcNAQkEMSIEIPTKV8gZZi0F+Zlq3zelu49nsRojn0qKcZ5p
# 5zNnYRHxMA0GCSqGSIb3DQEBAQUABIICAFt0uScpMTwfNDq53gW65FrwPEDiIRF6
# vZAWsRYEKuF+knqHXf/D4FVWV5U5mcCwhg+E0PnvQ+xlzeV5zfG60uzQEjoIRcQe
# CgVg88u/Y4vjf2hqapEMdva8TjIUEKPRh8vhGo9gX+KDxyzTCxPKdeI5rdZKIxXN
# 7Fjp37+8aPLzvl2b612WzbRLr5/EXVT1vfJDAjOBkPwbsbTleJmrFJRXXsgdiCN0
# DQHOQHOiVTxpyWwWWXnxrC+vPZnnnQk0mc2mIRjbYfllcbrVPTHU3m4fiqI/ef3/
# OkKjLe8kyHjRYPSPvYduMsorjtNqZQE5wcBPp6pPkCQtvL/90uIN7eWOhmXmgMO8
# qV2bbYeoLEfK2j6wtb2QEy+KgsnO41hL36X+xBiAsSj7DvegAICB4QDejAwowj0x
# 5G/tMUpjdPqsJQomKRcIFbahuYHDMW6rIixfEYx1cuo05Ukmb6cmh14KGRjBRZow
# OlwKghtz3vWi3oW/i4/ae6C4CIq6bBWNRn0cRRPx9rD0LWl9X1pxXuzLO29gojeQ
# EzrNNpJ48sO94x4gvXjWfbW0uL9sZ1fqYhzZ/7bIajxSSCj0lCZtVP1A/joW/ON/
# RjSpjwG+zlqQR8l7Ya5NMFavAmUeuc6pfyPaWsivh+c95rWdvsx/Fy0h/wO4HdVg
# WwCZdp3//fi2oYITUTCCE00GCisGAQQBgjcDAwExghM9MIITOQYJKoZIhvcNAQcC
# oIITKjCCEyYCAQMxDzANBglghkgBZQMEAgIFADCB8AYLKoZIhvcNAQkQAQSggeAE
# gd0wgdoCAQEGCisGAQQBsjECAQEwMTANBglghkgBZQMEAgEFAAQgKNHjCXLS/WtT
# rJZfVzJVOeGINe2PDXnOrnUP2tDoyy0CFQC+a+WJFL83feZnod/9KNiHEwy5ZRgP
# MjAyMzAxMjIwMjI5MjJaoG6kbDBqMQswCQYDVQQGEwJHQjETMBEGA1UECBMKTWFu
...
# CyqGSIb3DQEJEAEEMBwGCSqGSIb3DQEJBTEPFw0yMzAxMjIwMjI5MjJaMD8GCSqG
# SIb3DQEJBDEyBDDA+Tv2bqmFQPfrEJALr6rxlBxIK6BamRCVTS8C62HpV18J9/h1
# Z97HHu2qdp7yh34wge0GCyqGSIb3DQEJEAIMMYHdMIHaMIHXMBYEFKs0ATqsQJcx
...
# Zph0fKlGNqd4LbkwDQYJKoZIhvcNAQEBBQAEggIABo1R+AaJU7YFnEbCER7K79Jt
# wA22jDbAIGCIDofmSsNpm6jtGtqwKFQy1s+x6b0yqtA3VYtcSd2XfE0fmjH/GOCj
# 4sgy0U+q/g2u1LWe4HyYZRW+iMGyYPRyUwDtTu+EF408tmIWSZetbUKiUBtiriYa
# 9FL5HhGO+IoZT3LwxXXXvWmqFabI7+6+YJSjj0dykP9yzp5oOdmQRF1MZOGTwnzB
# 9VHVb6mK1TUOZnB34mQBGanz15XBF/XVFsQQ89VaT4rLZtq6gEwU8bZbTo8B4lMg
# 9xtb+umY/aiwIcKI1uAcnYxjMrociOUILPVXTNxHbTIxRLJbdwIQu1iEwFz7SjBT
# t7HJuvJp//EAUYv+ohuRufmwNUaqUOcDyeLcvt+xNKDN2wBWfUG+eERwyJHQOLHJ
# hTi2wcdSdZFoU8cBYSGoTCr1W4q9EUNPKoXDR9ktubra+GMPZQ/SQOVDb2R7d3Fu
# yFr3NSOxWVtN4P86WZS3mseGEevpGkHciJIFqytiLo3glBRPIy0EEhQ7VTsbyWN3
# p9Uz98ZzaKSicvH4MpZSNYfAx/BrmUSoci1bxasV0qeqfKIRGYKdHXthsnpLT969
# Vg4t9vVzHmAKkp4n+9dqVQ5kvb57ZKlmb509e7V/SyJgI6v5tyXRBImmvlnUWL8f
# sA2E3k8qcZX2g/vx4rg=
