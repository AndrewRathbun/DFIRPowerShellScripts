# This is a fork of https://github.com/gtworek/PSBits/blob/master/DFIR/ExtractFilenamesFromWindowsEDB.ps1
#
# TODO
# parameterize the location of the EDB file
# remove GUI components
# output to CSV? or something else
# 
