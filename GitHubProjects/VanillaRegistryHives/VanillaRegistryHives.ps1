...
# establish KAPE variables
$kape = 'C:\temp\kape.exe'

# establish a hash table of directories with labels (Key/Value pairs) and see if they exist, if not, create them
$folderPaths = @(
	@{ Name = 'vanillaRegistryHivesWorkingDir'; Path = 'C:\temp\RegistryHives' },
	@{ Name = 'vanillaRegistryHivesTout'; Path = 'C:\temp\RegistryHives\tout' },
	@{ Name = 'vanillaRegistryHivesMout'; Path = 'C:\temp\RegistryHives\mout' }
)
...
foreach ($folder in $folderPaths)
{
	...
	if (-not (Test-Path -Path $path -PathType Container))
	{
		...
		Write-Host "Folder $name created at $path"
	}
}

# Extract the values from the hash table and assign them to individual variables
$vanillaRegistryHivesWorkingDir = ($folderPaths | Where-Object { $_.Name -eq 'vanillaRegistryHivesWorkingDir' }).Path
$vanillaRegistryHivesTout = ($folderPaths | Where-Object { $_.Name -eq 'vanillaRegistryHivesTout' }).Path
$vanillaRegistryHivesMout = ($folderPaths | Where-Object { $_.Name -eq 'vanillaRegistryHivesMout' }).Path

$kapeArgs = "--tsource C --tdest {0} --target RegistryHives,RegistryHivesOther --zip %m --mdest {1} --module KapeResearch_Registry_JSON --mef csv --debug" -f $vanillaRegistryHivesTout, $vanillaRegistryHivesMout
$kapeCommand = "$kape $kapeArgs"

# run KAPE to grab registry hives, and output to JSON
# Invoke-Expression $kapeCommand

## establish filenames for our ZIP archives
$vanillaRegistryHivesJsonZipFilename = 'RegistryHivesJSON.zip'
$vanillaRegistryHivesZipFilename = 'RegistryHives.zip'

## establish full file paths for our ZIP archives
$vanillaRegistryHivesJsonZip = Join-Path -Path $vanillaRegistryHivesWorkingDir -ChildPath $vanillaRegistryHivesJsonZipFilename # C:\temp\RegistryHives\RegistryHivesJSON.zip
$vanillaRegistryHivesZip = Join-Path -Path $vanillaRegistryHivesWorkingDir -ChildPath $vanillaRegistryHivesZipFilename # C:\temp\RegistryHives\RegistryHives.zip

# compress contents of C:\RegistryHives\mout into C:\temp\RegistryHives\RegistryHivesJSON.zip
Compress-Archive -Path $vanillaRegistryHivesMout -DestinationPath $vanillaRegistryHivesJsonZip -Force

# copy contents of files within C:\RegistryHives\tout into C:\temp\RegistryHives\RegistryHives.zip
Copy-Item -Path "$vanillaRegistryHivesTout\*" -Include "*.zip" -Destination $vanillaRegistryHivesZip -Force 

# SIG # Begin signature block
# MIIviwYJKoZIhvcNAQcCoIIvfDCCL3gCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBr/lcOwxVfa3nx
# p3rRuzEWJijtyQcpAztcCRLJYe3IkaCCKJAwggQyMIIDGqADAgECAgEBMA0GCSqG
...
# CisGAQQBgjcCAQQwLwYJKoZIhvcNAQkEMSIE