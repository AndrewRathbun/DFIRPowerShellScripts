<#
    ...
    .PARAMETER MaxFileSizeInMB
        Please provide the max file size (in megabytes) of files you want Thor to scan. For example, 1000 (3 zeroes) means Thor will scan files 1000MB or less only. Change the 1 to any other number to work in values of thousands of megabytes
